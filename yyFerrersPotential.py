...
#            self.isNonAxi= True
    ...
    def _evaluate(self,R,z,phi=0.,t=0.):
        ...
        xyz= numpy.dot(self.rot(t),numpy.array([x,y,z]))
        x,y= xyz[0],xyz[1]    
    ...
    def _Rforce(self,R,z,phi=0.,t=0.):
        ...
        if new_hash == self._force_hash:
            ...
            self._cached_Fy= Fy
            self._cached_Fz= Fz
        Fxyz= numpy.dot(self.rot(t, transposed = True),numpy.array([Fx,Fy,Fz]))
        Fx, Fy= Fxyz[0], Fxyz[1]
    ...
    def rot(self, t=0., transposed = False):
        rotmat = numpy.array([[numpy.cos(self._pa+self._omegab*t),numpy.sin(self._pa+self._omegab*t),0.],
                        [-numpy.sin(self._pa+self._omegab*t),numpy.cos(self._pa+self._omegab*t),0.],
                        [0.,0.,1.]])
        if transposed:
            return rotmat.T
        else:
